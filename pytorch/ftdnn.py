...
class FTDNN(nn.Module):
    def __init__(self,feature_len,device=torch.device('cuda')):
        ...
        self.tdnn2_linear = nn.Conv1d(1024, 256, 2,dilation=2)
        ...
        self.tdnn4_linear = nn.Conv1d(1024, 256, 2,dilation=3)
        ...
        self.tdnn6_linear = nn.Conv1d(1024, 256, 2, dilation=3)
        ...
        self.tdnn7_linear = nn.Conv1d(1024, 256, 2,dilation=3)
        ...
        self.tdnn8_linear = nn.Conv1d(1024, 256, 2,dilation=3)
